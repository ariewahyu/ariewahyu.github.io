...
<html class="gr__127_0_0_1"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link href="./inc/assets.css" rel="stylesheet" type="text/css">
</head>
<body data-gr-c-s-loaded="true">  
  <nav id="sidebar">
    ...
    <ul id="links">
        <li><a href="https://ariewahyu.github.io/#about">About Me</a></li>
        <li><h2>Stuff</h2>
          <ul>
              <li class=""><a href="https://ariewahyu.github.io/#"></a></li>        
              <li class=""><a href="https://ariewahyu.github.io/#research">Research</a></li>
              <li class=""><a href="https://ariewahyu.github.io/#publication">Publication</a></li>
              <li class=""><a href="https://ariewahyu.github.io/#project">On Going Project</a></li>
              <li class=""><a href="https://ariewahyu.github.io/#experience">Experience</a></li>
...
>>>>>>> 995f26486aad4d16a30cb559b56fa289aee1e30b
    <section class="body">
      <!-- <h3 id="success">Success</h3> -->
        ...
        <p>Github: <a href="https://github.com/ariewahyu">ariewahyu</a><br>
        Email: ariewahyu {at} gmail {dot} com<br>
        Google Scholar: <a href="https://scholar.google.com/citations?user=HGow-iAAAAAJ&amp;hl=en">ariewahyu</a>
        </p>

        <p>Hi, my name is Arie Wahyu Wijayanto, a second year PhD student at Department of Computer Science, School of Computing, Tokyo Institute of Technology. I am a member of <a href="http://www.net.c.titech.ac.jp/index.html">Murata Laboratory</a> which specializes in research on artificial intelligence and Web mining. Currently, I am investigating some topics related to interdependent networks and deep neural networks. </p>

        <p>During my studies, I am under the supervision of Prof. Tsuyoshi Murata (<a href="http://www.titech.ac.jp/english/index.html">Tokyo Institute of Technology</a>). Previously I am closely working under the supervision of Dr. Ayu Purwarianti (<a href="https://www.itb.ac.id/">Bandung Institute of Technology</a>, Indonesia), Dr. Le Hoang Son (<a href="https://vnu.edu.vn/eng/">Vietnam National University</a>), Dr. Muchammad Romzi and Mr. Roby Darmawan (<a href="https://www.bps.go.id/">BPS - Statistics Indonesia</a>).</p>
...
<!-- .......... -->
  ...
  <article class="">
    <a name="research" href="https://ariewahyu.github.io/#research"><h2>Research</h2></a>
    <section class="body">
      
      <h3>Data Mining and Fuzzy Geo-Demographic Clustering</h3>
      
      <p>One of the most interesting interdisciplinary research topics between Geographic Information Systems and Data Mining are known as Geo-demographic analysis (GDA). Among some methods in this field, Fuzzy Geographically Weighted Clustering (FGWC) is considered as the state-of-the-art for Geo-demographic segmentation.</p> 
      
      <p>On the other hand, recent studies show that its quality of clustering achievement can be improved. One of its limitations is in cluster initialization phase, which performed randomly. In this research, we introduce a hybrid approach of FGWC based on metaheuristic optimization to overcome the limitation. The experimental evaluation through public data set studies shows that the proposed method obtains better clustering quality.</p>
      <p><img border="0" height="238" src="./inc/fgwc-ariewahyu.png" width="400"></p>

      <code>Paper:</code>
      <ul>
        <li>Arie Wahyu, Ayu Purwarianti, Le Hoang Son: Fuzzy geographically weighted clustering using artificial bee colony: An efficient geo-demographic analysis algorithm and applications to the analysis of crime behavior in population. Applied Intelligence 03/2016; 44(2). <a href="http://link.springer.com/article/10.1007/s10489-015-0705-7" target="_blank">Link</a></li>
...
<!-- .......... -->
  ...
  <article class="">
    <a name="publication" href="https://ariewahyu.github.io/#publication"><h2>Publication</h2></a>
    <section class="body">
      ...
      <ol>
            <li><b>Arie Wahyu Wijayanto</b>: Desain Sistem Terintegrasi Analisis Persepsi Publik pada Media Sosial Berbasis Internet of Thing untuk Pendukung e-Government Studi Kasus : Badan Pusat Statistik. e-Indonesia Initiatives (eII-Forum) 2014, Bandung; 06/2014. <a href="https://www.researchgate.net/publication/263889464_Desain_Sistem_Terintegrasi_Analisis_Persepsi_Publik_pada_Media_Sosial_Berbasis_Internet_of_Thing_untuk_Pendukung_e-Government_Studi_Kasus_Badan_Pusat_Statistik" target="_blank">Link</a></li>
      </ol>
...
<!-- .......... -->
  ...
  <article class="">
    <a name="project" href="https://ariewahyu.github.io/#project"><h2>On Going Project</h2></a>
    <section class="body">

      <h3>CREST-Deep</h3>
      <b>Fast and cost-effective deep learning algorithm platform for video processing in social infrastructure</b>
      <p>We aim to establish a high-performance real-time deep learning algorithm basis for detecting objects and anomalies from large amount of high definition videos. This project is funded by <a href="https://www.jst.go.jp/EN/">Japan Science and Technology Agency (JST)</a></p>

      <h3>RWBC-OIL</h3>
      <b>Compressing deep convolutional neural networks using complex network approaches</b>
      <p>We aim to compress Deep CNN to 1/100 based on its graph structure. This project is funded by <a href="http://www.aist.go.jp/index_en.html">National Institute of Advanced Industrial Science and Technology (AIST)</a></p>
...
<!-- .......... -->
  ...
  <article class="">
    <a name="experience" href="https://ariewahyu.github.io/#experience"><h2>Experience</h2></a>
    <section class="body">
...
<!-- .......... -->
  ...
  <article class="">
    <a name="professional-membership" href="https://ariewahyu.github.io/#professional-membership"><h2>Professional Membership</h2></a>
    <section class="body">
      <ul>
            <li><a href="http://www.ieee.org/" target="_blank">Institute of Electrical and Electronics Engineers (IEEE)</a>&nbsp;(ID: 94405134)</li>
            <li><a href="http://www.acm.org/" target="_blank">Association for Computing Machinery (ACM)</a>&nbsp;(ID: 5705602)</li>
            <li><a href="http://isi-indonesia.org/" target="_blank">Ikatan Perstatistikan Indonesia (ISI)</a></li>
      </ul>
      <ul>
            <li>ORCID &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; :&nbsp;<a href="http://orcid.org/0000-0001-5686-7218" target="_blank">0000-0001-5686-7218</a></li>
            <li>ResearcherID &nbsp; &nbsp; &nbsp;:&nbsp;<a href="http://www.researcherid.com/rid/P-3978-2016" target="_blank">P-3978-2016</a></li>
            <li>Scopus Author ID: <a href="https://www.scopus.com/authid/detail.uri?authorId=56524637100" target="_blank">56524637100</a></li>
      </ul>
      <a href="https://sites.google.com/site/ariewahyu/home/my_orcid_qrcode.png?attredirects=0" imageanchor="1" style="background-color:rgb(240,236,205);"><img border="0" height="100" src="./inc/my_orcid_qrcode.png" width="100"></a>
...
<!-- .......... -->
  ...
  <article class="">
    <a name="invited-talks" href="https://ariewahyu.github.io/#invited-talks"><h2>Invited Talks</h2></a>
    <section class="body">
      <ol>
          <li><b>Lecturer</b> on “Data Mining: Neural Network, Fuzzy Logic and Fuzzy Clustering” at “Institute of Statistics (STIS)”, Jakarta, Indonesia. July 2015.</li>
          <li><b>Trainer</b> on “Web Development Training using Code Igniter Framework” at “IPTEK.NET, Puspiptek Badan Pengkajian dan Penerapan Teknologi (BPPT)”, Serpong, Indonesia. June 2-5, 2014</li>
          <li><b>Invited Speaker</b> on “Service Oriented Architecture Overview” at “IPTEK.NET, Puspiptek Badan Pengkajian dan Penerapan Teknologi (BPPT), Serpong, Indonesia. September 2, 2014.</li>
      </ol>
      <br>
      <br>
